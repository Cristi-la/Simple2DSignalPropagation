function createWallDrawing(walls, roomSpace, transmiter, smallOutPut)
    ...
    line([0 roomSpace(1)], [0 0],'Color','green')
    line([0 0], [0 roomSpace(2)],'Color','green')
    line([roomSpace(1), roomSpace(1)], [0 roomSpace(2)],'Color','green')
    line([0 roomSpace(1)], [roomSpace(2) roomSpace(2)],'Color','green')
